...
require_once NDVWC_PLUGIN_DIR . 'includes/class-ndv-woo-calculator-price-engine.php';
require_once NDVWC_PLUGIN_DIR . 'includes/class-ndv-woo-calculator-pendant-engine.php';
...
function ndvwc_woocommerce_missing_notice()
{
    ...
    <div class="notice notice-error">
        <p><?php esc_html_e('NDV Woo Calculator requires WooCommerce to be installed and activated.', 'ndv-woo-calculator'); ?>
        </p>
    </div>
    <?php
}
